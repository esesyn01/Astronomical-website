    ...
    <div class="main">
        ...
        <div class="sidebar">
            ...
            <div class="maincontent">
                Zarejestruj się, wypełniając poniższy formularz:<br>
                <form action="register" method="post">
                    Podaj login:<input type="text" name="login">
                    <br>
                    Podaj swój adres e-mail:<input type="text" name="email">
                    <br>
                    Podaj hasło:<input type="password" name="pwd">
                    <br>
                    Powtórz hasło:<input type="password" name="rpt_pwd">
                    <br>
                    <input type="submit" value="Zajerestruj">
                </form>
                <a href="index">Kliknij tutaj, aby powrócić do strony głównej.</a>
            </div>
            <div class="space">
                space
            </div>
